...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_product'])) {
    ...
    if (empty($error) && $image) {
        ...
        $result = firebaseSet("products/$newId", $productData);
...
<div class="container py-5">
    ...
    <div class="page-header">
        ...
        <p>Tambahkan produk IoT baru ke toko Anda</p>
    </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="category" class="form-select" required>
                            ...
                            <option value="input" <?= ($_POST['category'] ?? '') == 'input' ? 'selected' : '' ?>>Input</option>
                            <option value="output" <?= ($_POST['category'] ?? '') == 'output' ? 'selected' : '' ?>>Output</option>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <button type="submit" name="add_product" class="btn btn-submit">
